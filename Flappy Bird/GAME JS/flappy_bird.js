    ...
    window.onload = function() {
        ...
        //load images
        birdImg = new Image();
        birdImg.src = "../GAME IMAGES/flappy_bird_Image2.png";
        birdImg.onload = function() {
            context.drawImage(birdImg, bird.x, bird.y, bird.width, bird.height);
        }

        topPipeImg = new Image();
        topPipeImg.src = "../GAME IMAGES/flappy_bird_Image4.png";

        bottomPipeImg = new Image();
        bottomPipeImg.src = "../GAME IMAGES/flappy_bird_Image3.png";
    ...
    function update() {
        ...
        for (let i = 0; i < pipeArray.length; i++) { 
            ...
            if (!pipe.passed && bird.x > pipe.x + pipe.width) {
                score += 5; //0.5 because there are 2 pipes! so 0.5*2 = 1, 1 for each set of pipes
                pipe.passed = true;
            }
